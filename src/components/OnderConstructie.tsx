        ...
        <div className="w-full max-w-[1400px] mx-auto px-6 py-12 font-roboto antialiased">
          <div className="flex items-center justify-center min-h-[50vh]">
            <motion.div
              ...
              className="bg-white rounded-lg xs:rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden max-w-lg w-full"
            >
              {/* Logo */}
              {data.logo_url && (
                <div className="p-4">
              ...
              <div className="bg-primary p-4 sm:p-6">
                <FaTools className="w-8 h-8 mx-auto mb-2 text-white" aria-label="Onder constructie" />
                <h1 className="text-xl sm:text-2xl font-bold text-white tracking-tight font-heading">
                  {data.title}
                </h1>
              </div>
              <div className="p-4 sm:p-6 text-center">
                <p className="text-gray-600 mb-4 font-body">{data.message}</p>
                {/* Countdown Timer */}
                {data.expected_date && (
                  <div className="mb-4">
                ...
                {data.social_links && data.social_links.length > 0 && (
                  <div className="mb-4">
                    <p className="text-sm text-gray-600 font-semibold mb-2">Volg ons</p>
                ...
                {data.contact_email && (
                  <div className="mb-4">
                    <p className="text-sm text-gray-600 font-semibold mb-2">Neem contact op</p>
                    <a
                      href={`mailto:${data.contact_email}`}
                      className="flex items-center justify-center gap-2 text-primary hover:text-indigo-700"
