        ...
        <div className="relative w-full max-w-2xl bg-white rounded-xl shadow-xl">
          ...
          <div className="p-6 max-h-[calc(100vh-16rem)] overflow-y-auto">
            <div className="prose prose-sm max-w-none text-gray-600 prose-headings:text-gray-900 prose-strong:text-gray-900">
              <p className="font-bold text-gray-900">Koninklijke Loop – 17 mei 2025</p>

              <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-4">Artikel 1: Definities</h3>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-4">Artikel 2: Deelname</h3>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-4">Artikel 3: Aansprakelijkheid</h3>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-4">Artikel 4: Persoonlijke eigendommen</h3>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-4">Artikel 5: Privacy</h3>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-4">Artikel 6: Geschillenregeling</h3>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-4">Artikel 7: Gedragsregels</h3>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-4">Artikel 8: Slotbepaling</h3>
